...
test('Sort products and verify cart items', async ({ page }) => {
    ...
    // Step 2: Numerical Sort Verification (Price Low -> High)
    ...
    // Step 3: Alphabetical Sort Verification (Name A -> Z)
    ...
    // Step 4: Multi-Product Cart Additions
    ...
    // Step 5: Shopping Basket Content Validation
